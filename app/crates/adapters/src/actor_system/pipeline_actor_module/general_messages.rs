...
use domain::value_objects::lifecycle_values::{
    ActorActions, ActorOperationStatus, ActorStatus, ReplicaFlowTelemetry,
};
...
pub struct GetFlowTelemetryMessage;

pub type GetFlowTelemetryMessageResult = Result<ReplicaFlowTelemetry, IoTBeeError>;
impl Message for GetFlowTelemetryMessage {
