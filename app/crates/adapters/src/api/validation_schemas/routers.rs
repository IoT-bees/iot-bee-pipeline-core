...
pub async fn create_validation_schema(
    ...
    use_case
        .create_validation_schema(org_id, &schema_data.name, &schema_data.json_schema_str()?)
        .await
        .map_err(|e| {
...
pub async fn get_validation_schema(
    ...
    let result = use_case
        .get_validation_schema_by_id(org_id, id)
        .await
        .map_err(|e| {
...
pub async fn update_validation_schema(
    ...
    use_case
        .update_validation_schema_name(org_id, id as u32, &schema_data.name)
        .await
        .map_err(|e| {
...
pub async fn update_validation_schema_json(
    ...
    use_case
        .update_validation_schema(org_id, id as u32, &schema_data.json_schema())
        .await
        .map_err(|e| {
...
pub async fn delete_validation_schema(
    ...
    use_case
        .delete_validation_schema(org_id, id)
        .await
        .map_err(|e| {
