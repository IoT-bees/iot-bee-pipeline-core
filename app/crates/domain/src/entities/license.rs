    ...
    pub fn limits(self) -> PlanLimits {
        match self {
            Self::Free => PlanLimits {
                ...
                included_messages_monthly: 10_000,
            ...
            Self::Starter => PlanLimits {
                ...
                included_messages_monthly: 1_000_000,
                alerts_enabled: false,
                premium_connectors: false,
                multi_user: false,
            },
            ...
            Self::Enterprise => PlanLimits {
                ...
                included_messages_monthly: 100_000_000,
                alerts_enabled: true,
                premium_connectors: true,
                multi_user: true,
            },
...
impl LicenseSubscription {
    ...
    /// True when the customer has paid in the past but Stripe currently flags
    /// the subscription as `past_due` or `unpaid`. UI should restrict
    /// mutations and surface a "payment failed" banner.
