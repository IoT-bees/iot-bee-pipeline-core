...
use adapters::api::contact::contact_scope;
//validation schemas
...
use adapters::api::usage::usage_scope;
...
impl ApiComposer {
    pub async fn run(db: Arc<InternalDataBase>) -> std::io::Result<()> {
        ...
        let usage_uc = app_state.usage_app_state();
        ...
        HttpServer::new(move || {
            ...
            App::new()
                ...
                .service(contact_scope(system_uc.clone()))
                ...
                .service(
                    web::scope("")
                        ...
                        .service(usage_scope(usage_uc.clone()))
                        .service(
