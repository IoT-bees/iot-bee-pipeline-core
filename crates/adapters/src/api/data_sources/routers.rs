...
pub async fn test_data_source(
    ...
    let raw_id = *id;
    let message = use_case.test_data_source(org_id, &id).await.map_err(|e| {
...
pub async fn create_data_source(
    ...
    use_case
        .create_data_source(org_id, &input_model)
        .await
        .map_err(|e| {
...
pub async fn get_data_source(
    ...
    let data_source = use_case.get_data_source(org_id, &id).await.map_err(|e| {
...
pub async fn list_data_sources(
    ...
    let data_sources = use_case.list_data_sources(org_id).await.map_err(|e| {
...
pub async fn update_data_source_name(
    ...
    use_case
        .update_data_source_name(org_id, &id, &new_name.name)
        .await
        .map_err(|e| {
            LOGGER.error(&format!(
...
pub async fn update_data_source(
    ...
    use_case
        .update_data_source(org_id, &id, &update_model)
        .await
        .map_err(|e| {
