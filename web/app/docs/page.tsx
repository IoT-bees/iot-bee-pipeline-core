      ...
      <div className="px-4 sm:px-6 lg:px-12 py-12 max-w-[1280px] w-full mx-auto">
        <div className="mb-10">
          ...
          <p className="text-[16px] text-[var(--color-fg-3)] mt-3 max-w-[680px]">
            Everything you need to install, configure and run iot-bee on your
            own infrastructure.
          </p>
        </div>
        ...
        <div className="flex gap-12">
          ...
          <div className="flex-1 min-w-0">
            ...
            <Section id="overview" number="01" title="Overview">
              <p>
                <strong>iot-bee</strong> is a self-hosted platform that connects
                ...
                UI; iot-bee handles the connections, validation, transforms and
            ...
            <Section id="quickstart" number="02" title="Quickstart">
              ...
              <SubSection id="first-admin" title="Create your admin account (first run)">
                <p>
                  iot-bee ships <strong>without any user</strong>. The very
...
$ pnpm dev   # http://localhost:3000`}</CodeBlock>
            ...
            <Section id="concepts" number="05" title="Concepts">
              <p>
                Five resources make up an iot-bee deployment. Get familiar with
      ...
      "operation": null
            ...
            <Section id="web-app" number="06" title="Using the web app">
              ...
              <SubSection title="Navigation">
                ...
                <p>
                  On mobile the tabs collapse into a hamburger drawer. Your
                    ...
                    },
                    {
                      ...
                      body: (
                        <>
                          ...
                          <InlineCode>https://iot-bee.vercel.app</InlineCode>).
