    ...
    >
      ...
      <div className="flex flex-col gap-16 lg:gap-20">
        <Step
          ...
          body="Pick the type, fill three fields, save. iot bees remembers it."
        >
        ...
        <Step
          ...
          body="List the fields you expect and the valid range. Bad messages get dropped, good ones get cleaned."
        >
          <div className="flex flex-col gap-2.5 max-w-[520px]">
            <FieldRow name="temperature" type="FLOAT" range="-50 → 150 °C" />
            <FieldRow name="humidity" type="FLOAT" range="0 → 100 %" />
            <FieldRow name="sensor_id" type="STRING" range="tag" />
        ...
        >
          <div className="flex gap-3 max-w-[640px] flex-wrap">
            <PipelineCard icon={Radio} label="SOURCE" value="Sensors plant A" />
            <PipelineCard
              icon={ListChecks}
              label="SCHEMA"
              value="Temp + humidity"
            />
            <PipelineCard icon={Database} label="STORE" value="Influx (prod)" />
          </div>
        </Step>
        ...
        <Step
          ...
          body="Press start; iot bees spins up workers and starts streaming. Stop, scale up or tear down whenever — no restart needed."
        >
